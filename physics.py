...
"""
/** TO-DO **/
- Non-render check for (rotated) rects
- Add air resistance
- Add friction

/** MATHEMATICS, IGNORE **/

BALL IN RECTANGLE DETECTION
determine which sides are colliding

//TOP
bottom of ball beneath top of rect, top of ball above top of rect
left of ball smaller than right of rect AND right of ball bigger than left of rect

//BOTTOM
top of ball above bottom of rect, bottom of ball beneath bottom of rect
left of ball smaller than right of rect AND right of ball bigger than left of rect

//LEFT
left of ball smaller than left of rect, right of ball bigger than left of rect
top of ball bigger than bottom of rect AND bottom of ball smaller than top of rect

//RIGHT
right of ball bigger than right of rect, left of ball smaller than right of rect
top of ball bigger than bottom of rect AND bottom of ball smaller than top of rect



EQUATIONS OF RECTANGLE SIDES
// possible optimization by storing the following at init of obj?
polygon1 = (other._x,other._y)
polygon2 = (other._x + other._width * cos(other._angle), other._y - other._width * sin(other._angle))
polygon3 = (other._x - other._height * sin(other._angle) + other._width * cos(other._angle), other._y - other._height * cos(other._angle) - other._width * sin(other._angle))
polygon4 = (other._x - other._height * sin(other._angle), other._y - other._height * cos(other._angle))

Side 1: collision if:
sqrt( (self._y - polygon1[1])² + (self._x - polygon1[0])² ) + sqrt( (self._y - polygon2[1])² + (self._x - polygon2[0])² ) < 2 * sqrt( (other._width/2)² + self._radius² )

Side 2: collision if:
sqrt( (self._y - polygon2[1])² + (self._x - polygon2[0])² ) + sqrt( (self._y - polygon3[1])² + (self._x - polygon3[0])² ) < 2 * sqrt( (other._height/2)² + self._radius² )

Side 3: collision if:
sqrt( (self._y - polygon3[1])² + (self._x - polygon3[0])² ) + sqrt( (self._y - polygon4[1])² + (self._x - polygon4[0])² ) < 2 * sqrt( (other._width/2)² + self._radius² )

Side 4: collision if:
sqrt( (self._y - polygon4[1])² + (self._x - polygon4[0])² ) + sqrt( (self._y - polygon1[1])² + (self._x - polygon1[0])² ) < 2 * sqrt( (other._height/2)² + self._radius² )
